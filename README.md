...
After cloning the device-specific sources, use lunch to configure the build for your device:
...
Patches are always welcome at PixelOS!

To submit your patches, register at [PixelOS Gerrit](https://review.pixelos.net).
